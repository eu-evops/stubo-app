...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    handleSubmit: function handleSubmit(e) {
	        ...
	        $.ajax({
	            ...
	            success: function success(data) {
	                ...
	                // mounting results
	                _reactDom2['default'].render(_react2['default'].createElement(CommandResultsComponent, { data: data }), document.getElementById("CommandResults"));
	            }
	        }).fail(function ($xhr) {
	...
	_reactDom2['default'].render(_react2['default'].createElement(ExecuteCommandsPanel, null), document.getElementById("ExecuteCommands"));
