...
/***/ function(module, exports, __webpack_require__) {
	        ...
	        $.ajax({
	            ...
	            success: function success(data) {
	                if (that.isMounted()) {
	                    ...
	                    // rendering name
	                    _reactDom2['default'].render(_react2['default'].createElement(ScenarioNameComponent, { key: data.data.scenario, data: data.data.scenario }), document.getElementById("scenarioName"));
	                }
	            }
	        }).fail(function ($xhr) {
	...
	_reactDom2['default'].render(_react2['default'].createElement(ExportInformation, null), document.getElementById("app"));
